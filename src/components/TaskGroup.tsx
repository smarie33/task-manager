...
const TaskGroup: React.FC<TaskGroupProps> = ({
  ...
  return (
    <Card
      className="w-[90vw] max-w-[1500px] flex flex-col rounded-tl-none shadow-lg"
      style={{ borderLeftWidth: 3, borderLeftColor: group.color }}
    >
      <CardHeader className="flex flex-row items-center justify-between py-1 px-3 rounded-tr-lg rounded-tl-none" style={{ backgroundColor: group.color }}>
